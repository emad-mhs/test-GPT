...
import { ContactInsertInput } from '../../schema';
import {
  Select,
  SelectContent,
  SelectItem,
...
type Props = {
  form: UseFormReturn<ContactInsertInput>;
  isAdmin: boolean;
  isDisabled?: boolean;
};

const fields: {
  name: keyof ContactInsertInput;
  label: string;
  placeholder: string;
}[] = [
  {
...
export const ContactFormFields = ({ form, isAdmin, isDisabled }: Props) => {
  return (
    <>
      {isAdmin && (
        <FormField
