...
import { DepartmentInsertInput } from '../../schema';

type Props = {
  form: UseFormReturn<DepartmentInsertInput>;
  isDisabled?: boolean;
};

const fields: {
  name: keyof DepartmentInsertInput;
  label: string;
  placeholder: string;
}[] = [
  {
...
export const DepartmentFormFields = ({ form, isDisabled }: Props) => {
  return (
    <>
      {fields.map(field => (
        <FormField
