...
interface ReceiptAttachmentFieldProps<TFieldValues extends FieldValues> {
  ...
  editable: boolean;
  isPending: boolean;
  printArea: RefObject<HTMLDivElement | null>;
  onPrint: () => void;
  attachments: ReactNode[];
}

export const ReceiptAttachmentField = <TFieldValues extends FieldValues>({
  name,
  label,
  icon,
  control,
  ...
  onPrint,
  attachments,
}: ReceiptAttachmentFieldProps<TFieldValues>) => {
  return (
    <FormField
      control={control}
      name={name}
                      ...
                      {editable && (
                        <div className='hover:cursor-pointer'>
                          ...
                          <div className='hidden'>
                            <div ref={printArea} className='space-y-3'>
                              {attachments}
                            </div>
                          </div>
                        </div>
